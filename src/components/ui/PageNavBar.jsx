...
/**
 * Reusable top navigation bar for standalone pages (no Layout wrapper).
 *
 * Props:
 *   title      — string shown in the center / after the divider
 *   titleIcon  — optional React element shown before the title
 */
export default function PageNavBar({ title, titleIcon }) {
